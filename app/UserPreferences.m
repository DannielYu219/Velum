...
- (instancetype)init {
    ...
    if (self) {
        ...
        [_defaults registerDefaults:@{
            ...
            kPreferenceCursorStyleKey: @(CursorStyleUnderline),
            kPreferenceHideStatusBarKey: @(YES),
